...
export class NotLoggedInWarning extends LitElement {
  ...
  render() {
    ...
    return html`<div class="no-crazygames flex items-center">
      <button
        class="px-4 py-2 text-xs font-bold uppercase tracking-wider transition-colors duration-200 bg-red-500/20 text-lt-bad border border-lt-bad/30 cursor-pointer hover:bg-lt-bad/30"
