  ...
  render() {
    ...
    return html`
      ...
      >
        <!-- Logo + Menu -->
        <div
          class="flex flex-col text-lt-accent mb-4 ml-[clamp(0.2rem,0.4vw,0.4vh)]"
        >
        ...
        <div
          class="flex flex-col w-full mt-auto [.in-game_&]:hidden items-end justify-end pt-4 border-t border-lt-700"
        ></div>
      </div>
    `;
  }
